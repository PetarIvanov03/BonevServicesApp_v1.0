...
{
    public partial class CarCategoryAdd : Form
    {
        ...
        public CarCategoryAdd(Car foundCar, KeyValuePair<string, List<string>> mainCategory, string subCatName)
        {
            InitializeComponent();
            ...
            this.Text = $"Bonev Services - {foundCar.Name} - {_mainCategory.Key} - {_subCatName} - Нов";

            this.label1.Text = $"{foundCar.Name} - {_subCatName}";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    _foundCar.NewRepair(_subCatName, textBox1.Text);
                    _foundCar.Save();
