...
{
    public partial class CarRepairsByDate : Form
    {
        private bool openAnotherForm = false;
        private Car _foundCar;
        public CarRepairsByDate(Car foundCar)
        {
            InitializeComponent();
            this._foundCar = foundCar;

            this.Text = $"Bonev Services - {_foundCar.Name} - Ремонти по дати";
            this.label1.Text = $"{_foundCar.Name} - Ремонти по дати";
            ...
            foreach (var item in _foundCar.RepairsByDate)
            {
